...
if ( !class_exists( 'YWRFD_Mandrill' ) ) {


    /**
     * Implements Mandrill for YWRFD plugin
     *
     * @class   YWRFD_Mandrill
     * @package Yithemes
     * @since   1.0.0
    ...
    class YWRFD_Mandrill {
        ...
        public function send_email( $to, $subject, $message, $headers, $attachments ) {
            ...
            if ( !class_exists( 'Mandrill' ) ) {
                require_once( YWRFD_DIR . 'includes/third-party/Mandrill.php' );
            }
    ...
    /**
     * Unique access to instance of YWRFD_Mandrill class
     *
     * @return \YWRFD_Mandrill
     */
    function YWRFD_Mandrill() {
        return YWRFD_Mandrill::get_instance();
    }
