        ...
        public function column_default ( $review, $column_name ) {
            ...
            switch ( $column_name ) {
                ...
                case $this->ywar->custom_column_review:
                    ...
                    echo '<span class="review-title">' . $title . '</span>';
                    echo '</a>';

                    if ( ! empty( $post->post_content ) ) {

                        echo '<br><span class="review-content">' . wc_trim_string ( $post->post_content, 80 ) . '</span>';
                    }
...
<span style="width:' . ( ( $rating / 5 ) * 100 ) . '%"><strong>' . $rating . '</strong>' . __ ( "out of 5", 'yith-woocommerce-advanced-reviews' ) . ' </span>
                ...
                case $this->ywar->custom_column_author:
                    ...
                    if ( $review->post_author ) {
                        ...
                        echo '<span class="review-author">' . $author_name . '</span>';
                        if ( $user ) {
                            echo '<br><span class="review-author-email">' . $user->user_email . '</span>';
                        }
