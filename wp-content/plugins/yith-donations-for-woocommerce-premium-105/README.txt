...
= 1.0.4 =
* Added: "include /exclude tax" option in "YITH Donations for WooCommerce - Summary" widget
* Fixed: custom sytle in loop
* Tweak: improvement of show donation button in loop
* Updated: Plugin core framework
