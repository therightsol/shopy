    ...
    class YITH_WC_Donations
    {
        ...
        private function _init_messages()
        {
            ...
            $messages = array(
                ...
                'already' => __('You have already added a donation to the cart', 'ywcds'),
                'success' => __('Thanks for your donation', 'ywcds'),
                'text_button' => __( 'Add a donation', 'ywcds' ),
                'negative'  =>  __( 'Please enter a number greater than 0', 'ywcds' )
            );
