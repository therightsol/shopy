...
if ( ! class_exists( 'YITH_WACP_Exclusions_Handler' ) ) {
    ...
    class YITH_WACP_Exclusions_Handler {
        ...
        public function __construct() {
            ...
            // search products
            add_action( 'wp_ajax_yith_wacp_search_products', array( $this, 'yith_wacp_search_products_ajax' ) );
            add_action( 'wp_ajax_nopriv_yith_wacp_search_products', array( $this, 'yith_wacp_search_products_ajax' ) );

            // search categories
            add_action( 'wp_ajax_yith_wacp_search_categories', array( $this, 'yith_wacp_search_categories_ajax' ) );
            add_action( 'wp_ajax_nopriv_yith_wacp_search_categories', array( $this, 'yith_wacp_search_categories_ajax' ) );
        }
         ...
         */
        public function yith_wacp_search_products_ajax(){
            ob_start();
         ...
         * @author Francesco Licandro <francesco.licandro@yithemes.com>
         */
        public function yith_wacp_search_categories_ajax(){
            ob_start();
