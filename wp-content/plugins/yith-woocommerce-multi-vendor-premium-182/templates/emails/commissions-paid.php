...
<p><?php _e( 'The commission has been credited successfully.', 'yith_wc_product_vendors' ) ?></p>

<?php do_action( 'woocommerce_email_before_commission_table', $commission, $sent_to_admin, $plain_text ); ?>

<h2><a href="<?php echo $commission->get_view_url( 'admin' ); ?>"><?php printf( __( 'Commission #%s detail', 'yith_wc_product_vendors'), $commission->id ); ?></a></h2>
