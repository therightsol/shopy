...
class YITH_WC_Email_Commissions_Unpaid extends WC_Email {
	...
	function __construct() {
		...
		$this->title 			= __( 'Commissions unpaid', 'yith_wc_product_vendors' );
		$this->description		= __( 'New commissions are credited to vendors', 'yith_wc_product_vendors' );

		$this->heading 			= __( 'Commissions unpaid', 'yith_wc_product_vendors' );
		$this->subject      	= __( '[{site_title}] - Commissions unpaid', 'yith_wc_product_vendors' );
