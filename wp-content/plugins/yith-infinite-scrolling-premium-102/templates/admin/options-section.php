				...
				<div class="section-body">
					<table>
						...
						<tr class="deps-button">
							...
							<td>
								<input type="text" name="<?php echo $name ?>[<?php echo $key ?>][buttonLabel]" id="<?php echo $id ?>[<?php echo $key ?>][buttonLabel]" value="<?php echo isset( $db_value[ $key ]['buttonLabel'] ) ? $db_value[ $key ]['buttonLabel'] : __( 'Load More', 'yith-infs' ) ?>">
