    ...
    class YITH_WCPSC_Admin_Premium extends YITH_WCPSC_Admin {
        ...
        public function __construct() {
            ...
            if ( current_user_can( 'edit_size_charts' ) ) {
                ...
                add_action( 'init', array( $this, 'add_product_metabox' ) );
        ...
        public function add_product_metabox() {
            ...
            $args    = array(
                'label'    => _x( 'Product Size Charts', 'Admin:title of Metabox', 'yith-wcpsc' ),
                'pages'    => 'product',
                'context'  => 'normal',
                'priority' => 'default',
                'tabs'     => apply_filters( 'yith_wcpsc_tabs_product_metabox_charts', array(
                    'settings' => array(
                        'label'  => _x( 'Product Size Charts', 'Admin:title of Metabox tab', 'yith-wcpsc' ),
                        'fields' => array(
                            'yith_wcpsc_product_charts' => array(
                                'label'    => _x( 'Product Size Charts', 'Admin:title of Metabox field', 'yith-wcpsc' ),
        ...
        public function add_chart_options_metabox( $tabs ) {
            $tabs[ 'settings' ][ 'fields' ] = array(
                'display_as'        => array(
                    'label'   => __( 'Display as', 'yith-wcpsc' ),
                    'desc'    => __( 'Select how you want display the chosen Product Size Chart.', 'yith-wcpsc' ),
                    'type'    => 'select',
                    'private' => false,
                    'options' => array(
                        'tab'          => __( 'Tab', 'yith-wcpsc' ),
                        'popup'        => __( 'Popup', 'yith-wcpsc' ),
                        'tabbed_popup' => __( 'Tabbed Popup', 'yith-wcpsc' ),
                    ),
                    'std'     => 'tab'
                ),
                'show_in_widget'    => array(
                    'label'   => __( 'Show in widget', 'yith-wcpsc' ),
                    'desc'    => __( 'Check it if you want to display the Product Size Chart in a Widget.', 'yith-wcpsc' ),
                    'type'    => 'checkbox',
                    'private' => false,
                    'std'     => true
                ),
                'title_of_desc_tab' => array(
                    'label'   => __( 'Title of description tab', 'yith-wcpsc' ),
                    'desc'    => __( 'Enter here the text you want display as title of the description tab of the selected Product Size Chart.', 'yith-wcpsc' ),
                    'type'    => 'text',
                    'private' => false,
                    'std'     => __( 'Description', 'yith-wcpsc' )
                ),
                'tab_priority'      => array(
                    'label'   => __( 'Tab position', 'yith-wcpsc' ),
                    'desc'    => __( 'Use this field to choose the position of the tab. Please consider the following WooCommerce priority order: 10 -> Description tab; 20 -> Additional Information tab; 30 -> Reviews tab', 'yith-wcpsc' ),
                    'type'    => 'number',
                    'min'     => '0',
                    'private' => false,
                    'std'     => 99,
        ...
        public function premium_settings_tabs( $tabs ) {
            $premium_tabs = array(
                'settings'         => __( 'Settings', 'yith-wcpsc' ),
                'advanced-display' => __( 'Advanced Display', 'yith-wcpsc' ),
            );
        ...
        public function get_shortcode_form() {
            ...
            echo '<p>' . __( 'Select the Product Size Chart you want to add', 'yith-wcpsc' ) . '</p>';
            ...
            echo '<input type="button" class="yith-wcpsc-shortcode-add button button-primary button-large" value="' . __( 'Add', 'yith-wcpsc' ) . '" />';
            echo '<input type="button" class="yith-wcpsc-shortcode-cancel button button-secondary button-large" value="' . __( 'Cancel', 'yith-wcpsc' ) . '" />';
        ...
        public function add_columns( $columns ) {
            $columns[ 'yith_wcpsc_product_size_charts' ] = _x( 'Product Size Charts', 'Admin:title of column in products table', 'yith-wcpsc' );
        ...
        public function admin_enqueue_scripts() {
            ...
            if ( $menu_slug . '_page_yith_wcpsc_panel' == $screen->id ) {
