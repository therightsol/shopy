			...
			<div class="action-rp action-section">
				<form name="resetpassform" id="resetpassform" action="" method="post">
					...
					<p>
						...
						<input data-reveal="1" type="password" name="pass1" id="pass1" class="input" data-pw="<?php echo esc_attr( wp_generate_password( 16 ) ); ?>" size="20" value="" autocomplete="off" /></label>
					</p>
					<p>
